...
public class CreateUserWithoutRequiredParametersTest {
    ...
    public void createUserWithoutRequiredParametersNegativeTest() {
        ...
        assertEquals(expectedSuccessStatus, actualResponse.getBody().as(CreateUserResponse.class).isSuccess());
        assertEquals(expectedResponseMessage, actualResponse.getBody().as(CreateUserResponse.class).getMessage());
